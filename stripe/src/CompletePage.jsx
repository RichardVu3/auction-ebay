...
export default function CompletePage() {
  ...
  useEffect(() => {
    ...
    window.opener.postMessage({ success: true }, "http://localhost:5173/cart");
      window.close(); // Close the current browser tab/window
    }, 5000);
...
return (
    <div id="payment-status">
        ...
        <a id="retry-button" href="javascript:void(0)" onClick={() => {
            window.opener.postMessage({ success: true }, "http://localhost:5173/cart");
            window.close();
        }}>Auto close in 5 ...</a>
    </div>
