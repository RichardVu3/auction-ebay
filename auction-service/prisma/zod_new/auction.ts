...
import { CompleteUser, RelatedUserModel, CompleteBid, RelatedBidModel, CompleteCategory, RelatedCategoryModel, CompleteWatchList, RelatedWatchListModel } from "./index"
 ...
 */
export const RelatedAuctionModel: z.ZodSchema<CompleteAuction> = z.lazy(() => AuctionModel.extend({
